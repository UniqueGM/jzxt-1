...
namespace Qx.Jzxt.Services
{
    public class OrgService : BaseRepository, IOrgService
    {
        ...
        public bool UpdateAssociationLeader(string leaderId, string associationId)
        {
            ...
            Db.user_position.AddOrUpdate(new user_position()
            {
        ...
        public List<SelectListItem> GetOrgItem(string user_id)
        {
            List<SelectListItem> orgItem = new List<SelectListItem>();
            ...
            {
                orgItem.Add(new SelectListItem() {Text=Db.orgnization.Find(item.orgnization_position.orgnization_id).name, Value = item.orgnization_position.orgnization_id.Trim() });
            }
            return orgItem;
        }
