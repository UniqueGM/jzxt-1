...
{
    public class CollegeAwardExamineNoPass_M
    {
        ...
        public static CollegeAwardExamineNoPass_M ToViewModel(string applyid, award_apply data)
        {
            return new CollegeAwardExamineNoPass_M()
            {
                applyid = applyid,
