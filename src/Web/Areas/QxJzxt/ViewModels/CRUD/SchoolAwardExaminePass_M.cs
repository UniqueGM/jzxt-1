...
{
    public class SchoolAwardExaminePass_M
    {
        ...
        public static SchoolAwardExaminePass_M ToViewModel(string applyid, award_apply data)
        {
            return new SchoolAwardExaminePass_M()
            {
                applyid = applyid,
