...
namespace Web.Controllers.Base
{
    public class BaseController : Controller
    {
        ...
        public class ReportUI
        {
            ...
            public string ShowDeafultButton;
            public string DbConnStringKey;
            public string DataSourceUrl;
            public string FormControlConfig;
        ...
        public class FormUI
        {
            public FormUI(int code, string msg, string url, object data)
            {
                this.code = code;
                this.msg = msg;
                this.url = url;
      ...
      public enum State 
      {
        ...
        protected ActionResult Json(State state, string msg, string url="", object data=null)
        {
            if (data == null)
            {
                data = new {};
            ...
            return Json(new FormUI((int)state, msg, url, data), JsonRequestBehavior.AllowGet);
        }
        protected ActionResult Json(State state,  object data)
        {
            if (data == null)
            {
                data = new { };
            ...
            //Response.Headers.Add("Access-Control-Allow-Origin", "*");
            return Json(new FormUI((int)state, "", "", data), JsonRequestBehavior.AllowGet);
        }
